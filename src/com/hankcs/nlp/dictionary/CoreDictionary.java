 ...
 * Trie树结构参考论文《中文分词器比较研究》，也称前缀树
 */
public class CoreDictionary {

    public static DoubleArrayTrie<Attribute> trie = new DoubleArrayTrie<Attribute>();   //NLP常用的基础树结构，参考开源实现

    public static final String path = Config.CoreDictionaryPath;
    public static final int totalFrequency = 221894;    //静态计算的总词频
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                for (int i = 0; i < natureCount; ++i) {
                    attribute.nature[i] = Enum.valueOf(Nature.class, param[1 + 2 * i]); //词性
                    attribute.frequency[i] = Integer.parseInt(param[2 + 2 * i]);    //单个词性的词频
                    attribute.totalFrequency += attribute.frequency[i]; //总词频
                }
