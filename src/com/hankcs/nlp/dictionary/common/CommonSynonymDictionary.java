...
import com.hankcs.nlp.dictionary.base.synonym.SynonymHelper;
import com.hankcs.nlp.NLPManager;
import com.hankcs.nlp.collection.trie.DoubleArrayTrie.DoubleArrayTrie;
import com.hankcs.nlp.dependence.CoNll.PosTagCompiler;
...
public class CommonSynonymDictionary {
    ...
    public String rewrite(String text) {
        List<Term> termList = NLPManager.getInstance().getSegment().seg(text.toCharArray());
        StringBuilder sbOut = new StringBuilder((int) (text.length() * 1.2));
        String preWord = Predefine.TAG_BIGIN;
    ...
    public static class SynonymItem {
        ...
        public static SynonymItem createUndefined(String word) {
            SynonymItem item = new SynonymItem(new Synonym(word, word.hashCode() * 1000000 + Long.MAX_VALUE / 3), null, Synonym.Type.UNDEFINED);
            return item;
        }
    }
}
