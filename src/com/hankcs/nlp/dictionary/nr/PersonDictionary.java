...
import com.hankcs.nlp.dictionary.TransformMatrixDictionary;
...
import static com.hankcs.nlp.dictionary.base.tag.NR.*;
import static com.hankcs.nlp.util.LogUtil.logger;
import static com.hankcs.nlp.dictionary.nr.NRConstant.*;
...
public class PersonDictionary {
    ...
    static {
        ...
        if (!dictionary.load(Config.PersonDictionaryPath)) {
            throw new IllegalArgumentException("人名词典加载失败：" + Config.PersonDictionaryPath);
        }
