...
import com.hankcs.nlp.semantic.word2vec.base.VocabWord;
import com.hankcs.nlp.semantic.word2vec.corpus.CacheCorpus;
import com.hankcs.nlp.semantic.word2vec.corpus.AbstractCorpus;
import com.hankcs.nlp.semantic.word2vec.corpus.TextFileCorpus;
...
class Word2VecTraining {
    ...
    static class TrainModelThread extends Thread {
        ...
        public TrainModelThread(Word2VecTraining vec, AbstractCorpus corpus, Config config, int id) {
            this.vec = vec;
            this.corpus = corpus;
            this.config = config;
                ...
                while (true) {
                    if (word_count - last_word_count > 10000) {
                        ...
                        if (config.getCallback() == null) {
                            ...
                            String etd = CommonUtils.humanTime((long) (cost_time / percent * (1.f - percent)));
    ...
    public void trainModel() throws IOException {
        ...
        System.err.println();
        logger.info(String.format("finished training in %s", CommonUtils.humanTime(System.currentTimeMillis() - timeStart)));
        // lose weight
        syn1 = null;
        table = null;
    ...
    void initUnigramTable(AbstractCorpus corpus) {
        final int vocabSize = corpus.getVocabSize();
        final VocabWord[] vocab = corpus.getVocab();
    ...
    void initNet(AbstractCorpus corpus) {
        final int layer1Size = config.getLayer1Size();
        final int vocabSize = corpus.getVocabSize();
